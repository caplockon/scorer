...
<template>
    <div class="mb-6">
        ...
        <input @keyup="$emit('keyup')" :value="modelValue" v-bind="$attrs" @input="$emit('update:modelValue', $event.target.value)"
               type="text" :class="inputClasses" :disabled="disabled" autocomplete="off">
